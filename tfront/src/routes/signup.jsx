          ...
          <div className="row w-100">
            <div className="col-sm-6 text-white">
              <form style={{ width: "23rem", backgroundColor: 'rgba(0, 0, 0, 0.7)', padding: '2rem', borderRadius: '1.3rem' }} onSubmit={handleSignup}>
                <h3 className="fw-normal mb-3 pb-3" style={{ letterSpacing: "0px", fontFamily: 'Futura, sansSerif', color: 'whitesmoke' }}>SIGNUP</h3>
                ...
                <div className="form-outline mb-4">
                  <input 
                    ...
                    required
                  />
                  <label className="form-label" htmlFor="fullName" style={{ fontFamily: 'Futura, sansSerif', color: 'whitesmoke', opacity: '0.9' }}>FULL NAME</label>
                </div>
                ...
                <div className="pt-1 mb-3">
                  <button type="submit" className="btn btn-light" style={{ borderRadius: '1.7rem', textAlign: 'center', fontFamily: 'Futura, sansSerif' }}>SIGNUP</button>
                </div>
              </form>
            </div>
          </div>
